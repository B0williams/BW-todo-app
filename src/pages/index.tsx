...
export default function Home() {
  const [todoItem, setTodoItems] = useState<TodoItem[]>(defaultTodoItems);
  ...
  return (
    <>
      ...
      <main className={styles.main}>
        ...
        <TaskInput createItem={function (todoItem: TodoItem): void {
        ...
        <AnimatePresence mode="popLayout">
            {todoItem.map((item) => (
              <motion.div
                ...
                exit={{ opacity: 0 }}
              >
               <TodoItem item={item} deleteItem={function (id: string): void {
                  throw new Error("Function not implemented.");
